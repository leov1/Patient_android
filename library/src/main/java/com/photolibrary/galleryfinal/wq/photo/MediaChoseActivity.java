package com.photolibrary.galleryfinal.wq.photo;
...
import com.photolibrary.galleryfinal.wq.photo.util.StatusBarCompat;
import com.photolibrary.galleryfinal.wq.photo.widget.PickConfig;
import com.photolibrary.galleryfinal.yalantis.ucrop.UCrop;
...
public class MediaChoseActivity extends ActionBarActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (imasgemap.size() < 1) {
            ...
            if (chosemode == PickConfig.MODE_MULTIP_PICK) {
                menu.findItem(R.id.menu_photo_count).setTitle("确认(" + imasgemap.size() + "/" + max_chose_count + ")");
            } else {
                menu.findItem(R.id.menu_photo_count).setTitle("确认(1)");
            }
        }
